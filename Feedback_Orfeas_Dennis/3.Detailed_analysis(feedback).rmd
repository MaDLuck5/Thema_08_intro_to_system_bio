...
>how do u know that steady state one always hits on T=30 and it seems like the implimentation of D = 0 doesnt fully work with a ifelse statement inside the model fucntion, have u looked at the event and root parameters u can give to the ODE fucntion ? also your model doesnt stop when the second steady state with D = 0 is hit .
