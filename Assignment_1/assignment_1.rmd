...
parameter_list <- list(c(r = 0.5,m = 40), c(r = 0.5, m = 50), c(r = 0.5 ,m = 60))
...
plot(as.data.frame(out[2]), type = "line", col = "blue")
lines(as.data.frame(out[1]), type = "line", col = "red")
lines(as.data.frame(out[3]), type = "line", col = "green")
legend(15,140, legend = c("steady state" ,"mRNA increasing", "mRNA decreasing" ), border = c("blue", "green",  "red"), fill = TRUE)
```
