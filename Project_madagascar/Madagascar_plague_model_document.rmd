...
abstract: >
  During this experiment there (finish writing)
date: June 15th, 2022
output:
    pdf_document:
      toc: true
...
The plague has once been one of the deadliest natural disasters in human history, referred to as the Black Death, attributed to the bacterium 'Yersinia pestis'. (Boire et al., 2014)
...
(expand on the disease, perhaps the means of spread, fleas, rats & pathogenesis.)
...
Herein the S, E, I describe Susceptible, Exposed, and Infectious and the subscripts b & p denote the bubonic and pneunomic form.
...
The infected cases are assumed to recover and die with the total rate of removal from the infected pool being $\delta_b$ and $\delta_p$ for bubonic and pnuemonic cases.
