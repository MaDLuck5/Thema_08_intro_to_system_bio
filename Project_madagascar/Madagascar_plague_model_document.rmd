...
The plague has once been one of the deadliest natural disasters in human history, referred to as the Black Death, attributed to the bacterium 'Yersinia pestis'. (source here)
...
Madagascar, Tanzania, Vietnam, China & the USA. (source here)
...
nu <- array(c(unit_vector(2, D) - unit_vector(0, D), unit_vector(3, D) - unit_vector(0, D),
               ...
               unit_vector(5, D) - unit_vector(4, D)), dim = c(8,5))
...
change_func <- function(n, firings, nu) {
  ...
  for (i in seq(1,n)) {
    ...
    prechange <- c(prechange,(firings[i]*nu[i]))
